...
export default function Features() {
  return (
    <div className="max-w-6xl mx-auto p-6 lg:py-40">
      <h3 className="text-2xl lg:text-6xl font-bold text-center">
        Key Features
      </h3>
      <p className=" mt-5 lg:mt-10 lg:mb-16 text-xl text-center">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-x-5">
        {featuresData.map(({ icon: Icon, text, bg, delay }, index) => (
          <Reveal
            key={index}
            position="right"
            delay={delay}
