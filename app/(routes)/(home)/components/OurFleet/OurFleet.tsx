...
export default function OurFleet() {
  return (
    <div className="max-w-6xl mx-auto text-center py-12 lg:py-40 p-6">
      ...
      <p className="text-lg mt-2 lg:mt-5 lg:text-xl text-center w-full mx-auto max-2xl mb-5 lg:mb-10">
        Don't deny yourseld pleasure of driving the best premium cars from
        around the world.
      </p>
